...
import game_player_1 from "../assets/monitor.png";
  ...
  return (
    <div className="w-full group relative">
          <Link to="/all_products" className=" relative flex flex-col gap-2 ">
            ...
            <div className="p-3">
              <h3 className='font-semibold py-3'>HAVIT HV-G92 Gamepad</h3>
            ...
            <button class="w-full absolute bottom-26 left-1/2 transform -translate-x-1/2 bg-black text-white px-4 py-2">
              Add to Cart
            </button>
          </Link>
        </div>
